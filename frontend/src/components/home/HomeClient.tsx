...
const TX = {
  FR: {
    hero_line1: 'Comprendre les situations complexes',
    hero_line2: 'par une carte.',
    hints: [
    ...
    upload: 'Télécharger',
    plug: 'Plug',
    block_help: 'Aide du bloc',
    upload_title: 'Ajouter un fichier',
    plug_title: 'Connecter une source privée',
    send_title: 'Envoyer le message',
    compass_title: 'Générer la carte',
  ...
  EN: {
    hero_line1: 'Understanding complex situations',
    hero_line2: 'through a card.',
    hints: [
    ...
    upload: 'Upload',
    plug: 'Plug',
    block_help: 'Block help',
    upload_title: 'Add a file',
    plug_title: 'Connect a private source',
    send_title: 'Send message',
    compass_title: 'Generate card',
  ...
  ES: {
    hero_line1: 'Comprender situaciones complejas',
    hero_line2: 'con una carta.',
    hints: [
      'Un conflicto de equipo alrededor de una reorganización',
      'Una decisión estratégica con varias opciones',
      'Una crisis geopolítica en desarrollo',
      'Mi pareja se ha alejado: ¿cómo abordarlo?',
      'Se abre una oportunidad, pero el momento parece malo',
    ],
    describe: 'Describe tu situación en texto libre.',
    analysing: 'Análisis en curso...',
    waiting: 'La SC aparecerá aquí',
    flash_title: 'Flash Update',
    flash_sc_btn: 'Situation Card completa',
    clarify_intro: 'Para analizar tu situación:',
    clarify_btn: 'Analizar',
    tab_situation: 'Situación',
    tab_cap: 'Rumbo',
    tab_analyse: 'Análisis',
    partager: 'Compartir',
    lectures: 'Lecturas',
    ...
    saved: 'Guardar',
    tagline: 'Ver la estructura para poder decidir',
    signature: '¿Qué está pasando realmente?',
    offres: 'Planes',
    connexion: 'Iniciar sesión',
    structural_reading: 'Lectura estructural - no es una actualización en tiempo real',
    upload: 'Subir',
    plug: 'Plug',
    block_help: 'Ayuda del bloque',
    upload_title: 'Añadir un archivo',
    plug_title: 'Conectar una fuente privada',
    send_title: 'Enviar mensaje',
    compass_title: 'Generar la carta',
    ...
    generated_by: 'Generado por IAAA+ SIS',
    on_lbl: 'el',
  },
  DE: {
    hero_line1: 'Komplexe Situationen verstehen',
    hero_line2: 'mit einer Karte.',
    hints: [
      'Ein Teamkonflikt rund um eine Reorganisation',
      'Eine strategische Entscheidung mit mehreren Optionen',
      'Eine geopolitische Krise in Entwicklung',
      'Mein Partner zieht sich zurück: Wie spreche ich es an?',
      'Eine Chance öffnet sich, aber der Zeitpunkt wirkt schlecht',
    ],
    describe: 'Beschreiben Sie Ihre Situation frei.',
    analysing: 'Analyse läuft...',
    waiting: 'Die SC erscheint hier',
    flash_title: 'Flash Update',
    flash_sc_btn: 'Vollständige Situation Card',
    clarify_intro: 'Um Ihre Situation zu analysieren:',
    clarify_btn: 'Analysieren',
    tab_situation: 'Situation',
    tab_cap: 'Kurs',
    tab_analyse: 'Analyse',
    partager: 'Teilen',
    ...
    public_lbl: 'Öffentlich',
    historique: 'Verlauf',
    saved: 'Speichern',
    tagline: 'Die Struktur sehen, um entscheiden zu können',
    signature: 'Was geschieht wirklich?',
    offres: 'Angebote',
    connexion: 'Anmelden',
    structural_reading: 'Strukturelle Lesart - kein Echtzeit-Update',
    upload: 'Hochladen',
    plug: 'Plug',
    block_help: 'Blockhilfe',
    upload_title: 'Datei hinzufügen',
    plug_title: 'Private Quelle verbinden',
    send_title: 'Nachricht senden',
    compass_title: 'Karte generieren',
    ...
    generated_by: 'Erstellt von IAAA+ SIS',
    on_lbl: 'am',
  },
  IT: {
    hero_line1: 'Comprendere situazioni complesse',
    hero_line2: 'con una carta.',
    hints: [
      'Un conflitto di squadra attorno a una riorganizzazione',
      'Una decisione strategica con più opzioni',
      'Una crisi geopolitica in sviluppo',
      'Il mio partner si è allontanato: come parlarne?',
      'Si apre un’opportunità, ma il tempismo sembra sbagliato',
    ],
    describe: 'Descrivi liberamente la tua situazione.',
    analysing: 'Analisi in corso...',
    waiting: 'La SC apparirà qui',
    flash_title: 'Flash Update',
    flash_sc_btn: 'Situation Card completa',
    clarify_intro: 'Per analizzare la tua situazione:',
    clarify_btn: 'Analizza',
    tab_situation: 'Situazione',
    tab_cap: 'Direzione',
    tab_analyse: 'Analisi',
    partager: 'Condividi',
    lectures: 'Letture',
    ...
    saved: 'Salva',
    tagline: 'Vedere la struttura per poter decidere',
    signature: 'Che cosa sta succedendo davvero?',
    offres: 'Offerte',
    connexion: 'Accedi',
    structural_reading: 'Lettura strutturale - non un aggiornamento in tempo reale',
    upload: 'Carica',
    plug: 'Plug',
    block_help: 'Aiuto del blocco',
    upload_title: 'Aggiungi un file',
    plug_title: 'Collega una fonte privata',
    send_title: 'Invia messaggio',
    compass_title: 'Genera la carta',
    ...
    generated_by: 'Generato da IAAA+ SIS',
    on_lbl: 'il',
  },
  PT: {
    hero_line1: 'Compreender situações complexas',
    hero_line2: 'com um cartão.',
    hints: [
      'Um conflito de equipa em torno de uma reorganização',
      'Uma decisão estratégica com várias opções',
      'Uma crise geopolítica em desenvolvimento',
      'O meu parceiro afastou-se: como abordar o assunto?',
      'Uma oportunidade surge, mas o timing parece mau',
    ],
    describe: 'Descreva livremente a sua situação.',
    analysing: 'Análise em curso...',
    waiting: 'A SC aparecerá aqui',
    flash_title: 'Flash Update',
    flash_sc_btn: 'Situation Card completa',
    clarify_intro: 'Para analisar a sua situação:',
    clarify_btn: 'Analisar',
    tab_situation: 'Situação',
    tab_cap: 'Rumo',
    tab_analyse: 'Análise',
    partager: 'Partilhar',
    lectures: 'Leituras',
    ...
    saved: 'Guardar',
    tagline: 'Ver a estrutura para poder decidir',
    signature: 'O que está realmente a acontecer?',
    offres: 'Planos',
    connexion: 'Entrar',
    structural_reading: 'Leitura estrutural - não é uma atualização em tempo real',
    upload: 'Carregar',
    plug: 'Plug',
    block_help: 'Ajuda do bloco',
    upload_title: 'Adicionar um ficheiro',
    plug_title: 'Ligar uma fonte privada',
    send_title: 'Enviar mensagem',
    compass_title: 'Gerar o cartão',
    ...
    generated_by: 'Gerado por IAAA+ SIS',
    on_lbl: 'em',
  },
}

type HomeLang = keyof typeof TX
const HOME_LANGS: HomeLang[] = ['FR', 'EN', 'ES', 'DE', 'IT', 'PT']
const HOME_LANG_TO_LOCALE: Record<HomeLang, string> = {
  FR: 'fr',
  EN: 'en',
  ES: 'es',
  DE: 'de',
...
function contentLangFor(lang: HomeLang): 'FR' | 'EN' {
  return lang === 'FR' ? 'FR' : 'EN'
}

function dateLocaleFor(lang: HomeLang): string {
  return {
    FR: 'fr-FR',
    EN: 'en-GB',
    ES: 'es-ES',
...
function homeLangFromParam(value: string | null): HomeLang | null {
...
function Boussole({ mode, onClick, disabled, title = 'Générer la carte' }: {
  mode: CompassMode; onClick: () => void; disabled: boolean; title?: string
}) {
...
function SituationCardPanel({ sc, lang, onExpand }: {
  sc: Record<string, any>; lang: HomeLang; onExpand: () => void
}) {
  ...
  async function fetchResourcesData() {
    if (isGenerationDegraded) {
      if ((sourceItems?.length ?? 0) === 0 && sources.length > 0) {
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ borderTop: `1px solid ${BDR_G}`, paddingTop: 10, marginTop: 4 }}>
              ...
              <div style={{ fontSize: 10, color: TXT3, lineHeight: 1.7 }}>
                <div>{TX[lang].generated_by} · {TX[lang].on_lbl} {new Date().toLocaleDateString(dateLocaleFor(lang), { day: '2-digit', month: 'long', year: 'numeric' })}</div>
...
// ── COMPOSANT PRINCIPAL ───────────────────────────────────────────────────────
export default function HomeClient({ initialLang = 'FR' }: { initialLang?: HomeLang }) {
  const searchParams = useSearchParams()
  const urlLang = homeLangFromParam(searchParams.get('lang'))
  const [lang, setLang]               = useState<HomeLang>(initialLang)
  ...
  const t = TX[lang]
  const contentLang = contentLangFor(lang)
  const routeLocale = HOME_LANG_TO_LOCALE[lang]
  ...
  function handleMaterialSelected(event: ChangeEvent<HTMLInputElement>) {
            ...
            {group.items.map((item) => {
              ...
              return (
                <div key={item.title} style={{ padding: '9px 0', borderBottom: `1px solid ${BDR}`, cursor: 'pointer' }}>
                  ...
                  <div style={{ fontSize: 10, color: TXT3, marginTop: 4 }}>{item.trace[contentLang]}</div>
                </div>
              )
            })}
          </div>
        ...
        {SAVED_CATEGORIES.map((category) => (
          <div key={category.label.FR} style={{ marginBottom: 14 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 7 }}>
              ...
              <div style={{ fontSize: 12, color: NAVY, fontFamily: "'Cinzel',serif", letterSpacing: '.06em' }}>{category.label[contentLang]}</div>
            </div>
              ...
              return (
                <div key={item.title} style={{ marginLeft: 15, marginBottom: 8, padding: '9px 10px', border: `1px solid ${BDR}`, borderRadius: 8, background: '#fff' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginTop: 6, flexWrap: 'wrap' }}>
                    ...
                    <span style={{ fontSize: 10, color: TXT2 }}>{item.state[contentLang]}</span>
                    {item.editedBy && <span style={{ fontSize: 10, color: TXT3 }}>{lang === 'FR' ? `Modifié par ${item.editedBy}` : `Edited by ${item.editedBy}`}</span>}
                  </div>
                  <div style={{ fontSize: 10, color: TXT3, marginTop: 4 }}>{item.meta[contentLang]}</div>
                </div>
              )
            })}
          </div>
        ...
        <main style={{ maxWidth: 1160, margin: '0 auto', padding: '24px 28px 0' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, minHeight: 'clamp(420px, 58vh, 480px)' }}>
            ...
            <div style={{ background: BG_P, border: `1px solid ${BDR}`, borderRadius: 16, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
              <div style={{ display: 'flex', alignItems: 'center', borderBottom: `1px solid ${BDR}`, padding: '8px 16px', gap: 8 }}>
                <button
                  type="button"
                  onClick={handleUploadClick}
                  title={t.upload_title}
                  style={{ padding: '7px 10px', fontSize: 12, color: TXT2, cursor: 'pointer', border: `1px solid ${BDR}`, background: BG_P, borderRadius: 8 }}
                >
                  {t.upload}
                </button>
                <button
                ...
                <button
                  ...
                  style={{ width: 28, height: 28, marginLeft: 'auto', borderRadius: '50%', border: `1px solid ${leftHelpOpen ? GOLD : BDR}`, background: leftHelpOpen ? 'rgba(204,163,100,0.12)' : 'none', cursor: 'pointer', fontSize: 12, color: leftHelpOpen ? GOLD : TXT3 }}
                >
                  ?
                </button>
                <input
                  ref={fileInputRef}
                  type="file"
                  accept=".pdf,.doc,.docx,.txt,.md,.csv,.xlsx,.xls,image/*,application/pdf,text/*"
