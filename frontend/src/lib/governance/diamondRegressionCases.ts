...
export const DIAMOND_REGRESSION_CASES: DiamondRegressionCase[] = [
  ...
  },
  {
    ...
    expectations: {
      ...
      forbiddenTerms: [
        ...
        'riposte',
        'cessez-le-feu',
        'hostilités/cessez-le-feu',
        'la crise cesse d’être seulement commentée',
        'coût immédiat',
        'seuil public',
        'seuil militaire',
  ...
  {
    id: 'current-political-iran-01-07-keeps-political-spine',
    domain: 'geopolitics',
    input: 'Quelle est la situation politique en Iran au 1/07',
    expectations: {
      headerDomain: 'Géopolitique',
      forbiddenTerms: [
        'Aucune source affichable',
      ...
      visibleAxisVI: 'Incertitudes',
      notes:
        'Une question politique actuelle peut utiliser des ressources rapides, mais les signaux militaires des sources ne doivent pas devenir la colonne vertebrale de la carte.',
    },
  },
  {
