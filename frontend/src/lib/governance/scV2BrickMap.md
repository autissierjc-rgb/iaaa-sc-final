...
| ResonanceTrace minimal | resources / theatre / writing | branche public partiel | `src/lib/resonance`, `src/lib/contracts/resonance.ts`, `src/lib/writing/WritingEngine.ts` | Trace interne qui separe signaux sourcés, acteurs réels, institutions, structure manquante et confusions interdites avant redaction. |
