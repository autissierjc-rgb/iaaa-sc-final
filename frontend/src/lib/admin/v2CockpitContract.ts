...
export const V2_FOUNDATION_BRICKS: V2FoundationBrick[] = [
  ...
  {
    id: 'reaction-capture-route',
    label: 'Reaction capture route',
    layer: 'archive / admin-cockpit',
    status: 'wired',
    commit: 'c4251d7',
    files: ['src/app/api/reactions-v2/route.ts'],
    note: 'Expose une route V2 passive pour convertir une reaction de chat en evenement metadata-only mesurable.',
  },
  {
    id: 'reaction-tester',
    label: 'Reaction tester',
    layer: 'admin/cockpit',
    status: 'wired',
    commit: '019860d',
    files: ['src/app/sis-system/v2/ReactionV2Tester.tsx'],
